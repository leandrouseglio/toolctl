...
from . import pod_isolate_command
...
def cli(ctx, label_selector, namespace):
    """Isolate kubernetes pods based on label_selector."""
    load_kubernetes()
    try:
        ...
        confirm("Are you sure to isolate these pods?")  # noqa
        for pod in pods.items:
            ctx.invoke(
                pod_isolate_command.cli,
